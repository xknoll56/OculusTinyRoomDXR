...
static bool MainLoop(bool retryCreate)
{
    ...
    if (!DIRECTX.InitDevice(hmdDesc.Resolution.w / 2, hmdDesc.Resolution.h / 2, reinterpret_cast<LUID*>(&luid),
        depthFormat, eyeMsaaRate, true, idealSize.w/2, idealSize.h/2))
    {
        goto Done;
    }
    float idp;
    ...
    result = NVSDK_NGX_D3D12_CreateFeature(DIRECTX.CurrentFrameResources().CommandLists[0], NVSDK_NGX_Feature_ImageSuperResolution, DIRECTX.ngxParams, &DIRECTX.ngxFeatureHandle);
